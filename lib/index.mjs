...
*/
const WEB_SEARCH_TAVILY_SETTINGS_NAMESPACE = settingsModule.settingsNamespace?.("web-search-tavily") ?? "web-search-tavily";
/**
...
function apply(ctx, config) {
	...
	if (installLegacy !== void 0) installLegacy(ctx, WEB_SEARCH_TAVILY_SETTINGS_NAMESPACE, Config, config, hooks);
	else ctx.inject(["settings"], (settingsCtx) => {
		settingsCtx.settings.installSection(ctx, WEB_SEARCH_TAVILY_SETTINGS_NAMESPACE, Config, config, hooks);
	});
